...
$dokumen = explode(',', $kronologis['dokumen']);
$status = explode(',', $kronologis['statuss']);
function alert($msg)
{
        ...
        <div class="create-item">
            <form action="" method="post" enctype="multipart/form-data" class="dropzone" id="image-upload">
                ...
                <div class="title d-flex">
                    <p>Tanggal</p>
                    <p class="titik">:</p>
                    <input class="forum" type="text" name="tanggal" value="<?= $kronologis['tanggal'] ?>" id="" required>
                </div>
                <div class="title d-flex">
                ...
                <div class="title d-flex">
                    ...
                    <p class="titik">:</p>
                    <div class="cek">
                        <input class="forum forum1" type="file" name="lampiran" value="<?= $kronologis['lampiran'] ?>" /><br>
